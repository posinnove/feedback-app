...
export async function resendVerification(
  ...
  try {
    const result = await companyAuthService.resendCompanyVerification(
      req.body.email,
    );
    res.json(result);
  } catch (err) {
...
export async function forgotPassword(
  ...
  try {
    const result = await companyAuthService.forgotCompanyPassword(
      req.body.email,
    );
    res.json(result);
  } catch (err) {
...
export async function resetPassword(
  ...
  try {
    ...
    const result = await companyAuthService.resetCompanyPassword(
      token,
      password,
    );
    res.json(result);
...
export async function updateMeProfile(
  ...
  try {
    const id = req.auth!.id;
    const company = await companyAuthService.updateCompanyProfile(id, req.body);
    res.json(company);
  } catch (err) {
    next(err);
  }
...
export async function updateMeSettings(
  ...
  try {
    const id = req.auth!.id;
    const company = await companyAuthService.updateCompanySettings(
      id,
      req.body,
    );
    res.json(company);
...
export async function updateMePassword(
  ...
  try {
    const id = req.auth!.id;
    const result = await companyAuthService.changeCompanyPassword(id, req.body);
    res.json(result);
  } catch (err) {
    next(err);
  }
