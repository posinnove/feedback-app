...
export async function updateMeProfile(
  ...
  try {
    const id = req.auth!.id;
    const user = await userAuthService.updateUserProfile(id, req.body);
    res.json(user);
  } catch (err) {
    next(err);
  }
...
export async function updateMeSettings(
  ...
  try {
    const id = req.auth!.id;
    const user = await userAuthService.updateUserSettings(id, req.body);
    res.json(user);
  } catch (err) {
    next(err);
  }
...
export async function updateMePassword(
  ...
  try {
    const id = req.auth!.id;
    const result = await userAuthService.changeUserPassword(id, req.body);
    res.json(result);
  } catch (err) {
    next(err);
  }
