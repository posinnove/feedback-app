...
export default function FeedbackCard({ feedback, companySlug }: FeedbackCardProps) {
  return (
    <div className="card flex flex-col p-0 overflow-hidden hover:border-primary-600/30 transition-colors duration-200">
      {/* Header */}
      <div className="flex items-start justify-between gap-3 p-3 sm:p-4 pb-2">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 text-xs text-base-100 mb-1 flex-wrap">
        ...
        <button className="text-base-100 hover:text-base-200 p-1 cursor-pointer shrink-0">
      ...
      {/* Footer */}
      <div className="px-3 sm:px-4 pb-3 pt-2 mt-auto border-t border-border/50">
        <div className="flex items-center flex-wrap gap-2 sm:gap-3 text-xs text-base-100">
          <VoteButtons count={feedback.upvotes} />

          <div className="flex items-center gap-1 bg-border/50 rounded-md px-2 py-1 hover:bg-border transition-colors cursor-pointer">
