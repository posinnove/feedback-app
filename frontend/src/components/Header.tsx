  ...
  return (
    <header className="bg-white border-b border-border px-4 lg:px-6 py-3 flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2 lg:gap-3 ml-auto">
        ...
        <button
          className="sm:hidden p-2 text-base-100 hover:text-base-200 transition-colors"
          aria-label="Search"
        >
        ...
        {/* Notification Bell */}
        <button
          className="relative p-2 text-base-100 hover:text-base-200 transition-colors"
        ...
        <button
          className="hidden sm:block relative p-2 text-base-100 hover:text-base-200 transition-colors"
          aria-label="Help"
        >
        ...
        <div className="flex items-center gap-2 lg:gap-3 pl-2 lg:pl-3 border-l border-border">
          ...
          <button
            className="hidden md:block text-base-100 hover:text-base-200"
