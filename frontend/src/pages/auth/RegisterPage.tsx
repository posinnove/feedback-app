...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      {/* Right: Form Panel */}
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 lg:px-12 xl:px-16 py-10 bg-card-bg lg:border-l lg:border-border overflow-y-auto">
        <Link
          to="/"
