...
export default function VerifyEmailPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
            <div className="max-w-md w-full text-center card py-12 px-8">
                {/* Logo */}
                <Link to="/" className="inline-flex items-center gap-2 text-xl font-bold text-primary-600 mb-8">
                    <span className="w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center text-lg font-black">V</span>
                    VOXELLA
                </Link>
                ...
                {!token && (
                    <>
                        ...
                        <p className="text-base-100 text-sm mb-6">The verification link appears to be invalid.</p>
                        <Link to="/" className="inline-block px-6 py-2.5 bg-primary-600 text-white rounded-lg text-sm font-medium hover:bg-primary-800 transition-colors">
                            Go home
                        </Link>
                    </>
                )}
